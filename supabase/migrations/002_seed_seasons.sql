...
INSERT INTO seasons (name, start_date, end_date, price_per_night_house, price_per_night_apt, min_nights, apt_available) VALUES
  ...
  ('Vorsaison',   '2026-06-01', '2026-06-30', 38000, 21000, 5, true),
  ('Nachsaison',  '2026-09-01', '2026-09-30', 38000, 21000, 5, true),
  ('Zwischensaison Frühling', '2026-04-01', '2026-05-31', 33000, 21000, 6, true),
  ('Zwischensaison Herbst',   '2026-10-01', '2026-10-31', 33000, 21000, 6, true),
...
-- Zwischensaison: 330€/night house, 210€/night apartment
