      ...
      <div className="mt-6 flex flex-wrap items-center gap-4">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-300 py-2 pl-10 pr-4 text-sm focus:border-terracotta-500 focus:outline-none focus:ring-1 focus:ring-terracotta-500"
          />
        </div>
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="rounded-lg border border-gray-300 py-2 pl-3 pr-8 text-sm focus:border-terracotta-500 focus:outline-none focus:ring-1 focus:ring-terracotta-500"
          >
            ...
            <div className="mt-6 space-y-4 text-sm">
              ...
              <div>
                {selected.status === "awaiting_approval" && (
                  <div className="mb-4">
                    <p className="mb-2 font-medium text-terracotta-700">Buchung wartet auf Bestätigung</p>
