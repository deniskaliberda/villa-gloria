...
interface LandlordNotificationProps {
...
export function LandlordNotification({
  bookingNumber,
  guestName,
  guestEmail,
  guestPhone,
  ...
  return (
    <EmailLayout preview={`Neue Buchung: ${bookingNumber}`} lang="de">
      <Text
        style={{
          fontSize: "18px",
          fontWeight: "700",
      ...
      <table style={{ width: "100%", fontSize: "14px", color: "#2D2A26" }}>
        <tbody>
          ...
          <tr>
            <td style={{ padding: "4px 0", color: "#4A5D3A" }}>
              Anzahlung
            </td>
            <td
              style={{
